    ...
    return (
        <div className="p-6 lg:p-10">
            ...
            <div className="flex items-center gap-2 mb-6 text-sm">
                <button
                    onClick={goBack}
                    className={`flex cursor-pointer items-center gap-1 rounded-lg px-3 py-1.5 font-medium transition-colors ${!currentFolder
                ...
                {folderPath.map((folder, index) => (
                    <div key={folder.id} className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className={`rounded-lg px-3 py-1.5 font-medium transition-colors ${index === folderPath.length - 1
                                ? 'bg-black text-white dark:bg-white dark:text-black'
                                : 'text-zinc-500 hover:text-black dark:hover:text-white'
                                }`}
                        >
                ...
                <div className="mb-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 p-6">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-lg font-semibold text-black dark:text-white">
                            Upload File {currentFolder && 'to this folder'}
                        </h2>
                        <button
                            onClick={() => {
                                setShowUpload(false)
                        ...
                        <div>
                            ...
                            <div
                                ...
                                onDrop={(e) => {
                                    ...
                                    if (file) {
                                        ...
                                        // sync with the hidden file input so handleUpload reads it
                            ...
                            >
                                ...
                                <p className="text-sm text-zinc-500 dark:text-zinc-400">
                                    Drag & drop a file here, or <span className="font-medium text-black dark:text-white">browse</span>
                                </p>
                                <p className="text-xs text-zinc-400 mt-1">Max 2GB</p>
                            </div>
                            {/* Hidden input still needed for handleUpload to read files */}
                            <input
                                ref={fileInputRef}
                                type="file"
                            ...
                            <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 p-4">
                                <div className="flex items-center gap-3 mb-3">
                                    {selectedFile.type.startsWith('image/') ? (
                                        ...
                                        <div className="flex h-16 w-16 items-center justify-center rounded-lg bg-black/10 dark:bg-white/10">
                                            <File size={28} className="text-black dark:text-white" />
                                        </div>
                                    )}
                    ...
                    {sortedItems.map((item) =>
                        item.type === 'folder' ? (
                            <div
                                ...
                                className="relative rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 p-5 transition-all hover:border-zinc-400 dark:hover:border-zinc-600 cursor-pointer"
                            >
                            ...
                            <div
                                key={item.id}
                                className="relative rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 overflow-hidden transition-all hover:border-zinc-400 dark:hover:border-zinc-600"
                            >
                                ...
                                <div className="p-4">
                                    <div className="flex items-start justify-between mb-2">
                                        <p className="text-sm font-medium text-black dark:text-white truncate flex-1 mr-2">
                                            {item.original_name}
                                        </p>
                                        <div className="flex gap-1">
                                            <Tooltip text="View">
                    ...
                    {sortedItems.map((item) =>
                        item.type === 'folder' ? (
                            <div
                                key={item.id}
                                onClick={() => navigateToFolder(item.id)}
                                className="grid grid-cols-12 gap-4 px-6 py-4 border-t border-zinc-100 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-950 transition-colors items-center cursor-pointer"
                            >
                            ...
                            <div
                                key={item.id}
                                className="grid grid-cols-12 gap-4 px-6 py-4 border-t border-zinc-100 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-950 transition-colors items-center"
                            >
                                <div className="col-span-4 flex items-center gap-3">
